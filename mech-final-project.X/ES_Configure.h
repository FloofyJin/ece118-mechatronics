...
#define TIMER0_RESP_FUNC PostTrackWireService
#define TIMER1_RESP_FUNC PostBumperService
#define TIMER2_RESP_FUNC PostTopHSM
#define TIMER3_RESP_FUNC PostIrService
...
#define TRACK_SERVICE_TIMER 0
#define BUMPER_SERVICE_TIMER 1
#define HSM_TIMER 2
#define IR_SERVICE_TIMER 3
#define GLOBAL_TIMER 4
#define SNATCH_TIMER 5
#define STOP_TIMER 6
